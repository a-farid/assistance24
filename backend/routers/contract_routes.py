...
from settings.standarization import json_response_pagination, pagination_params
...
async def create_new_contract(body: T_Contract = Body(...), _=Ds(jwt_s.roles_allowed(["admin"]))):
    ...
    return json_response_pagination(new_contract, 200)
...
async def get_my_contracts(pagination: dict = Ds(pagination_params),token =Ds(jwt_s.roles_allowed(["worker", "client"]))):
    ...
    return json_response_pagination(**response, message="User contracts retrieved")
...
async def get_all_contracts(pagination: dict = Ds(pagination_params), _: dict =Ds(jwt_s.roles_allowed(["admin"]))):
    ...
    return json_response_pagination(**contracts, message="All contracts retrieved")
...
async def get_all_contracts(contract_id: str = Path(...),token=Ds(jwt_s.authorized_token)):
    ...
    return json_response_pagination(data=contract, message="Contract retrieved")
...
async def assign_worker_to_contract(contract_id: str = Path(...), worker_id: str = Path(...), _=Ds(jwt_s.roles_allowed(["admin"]))):
    ...
    return json_response_pagination(data=contract, status_code=201, message="Worker assigned to contract successfully")
...
async def assign_client_to_contract(contract_id: str = Path(...), client_id: str = Path(...), _=Ds(jwt_s.roles_allowed(["admin"]))):
    ...
    return json_response_pagination(data=contract, status_code=201, message="Client assigned to contract successfully")
...
async def update_contract(contract_id: str = Path(...), body: T_ContractUpdate = Body(...), _=Ds(jwt_s.roles_allowed(["admin"]))):
    ...
    return json_response_pagination(data=contract, status_code=201, message="Contract updated successfully")
...
async def delete_contract(contract_id: str = Path(...), _=Ds(jwt_s.roles_allowed(["admin"]))):
    ...
    return json_response_pagination(status_code=201)
...
async def detach_worker_from_contract(contract_id: str = Path(...), _=Ds(jwt_s.roles_allowed(["admin"]))):
    ...
    return json_response_pagination(data=contract, status_code=201, message="Worker removed successfully")
...
async def detach_client_from_contract(contract_id: str = Path(...), _=Ds(jwt_s.roles_allowed(["admin"]))):
    ...
    return json_response_pagination(data=contract, status_code=201, message="Client removed successfully")
